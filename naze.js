...
const nyoutube = ('𝐅𝐑𝐎𝐍𝐁𝐎𝐓 By © ᴍᴜʜᴀᴍᴍᴀᴅ ɴᴀꜰʀᴏɴ')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Nafron', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Naze Dev,;;;\nFN:Naze Dev\nitem1.TEL;waid=6285875158363:6285875158363\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('𝐔𝐩𝐩𝐬𝐬..𝐓𝐢𝐝𝐚𝐤 𝐚𝐝𝐚 𝐒𝐤𝐫𝐢𝐩𝐬𝐢 𝐮𝐧𝐭𝐮𝐤 𝐝𝐢 𝐭𝐚𝐦𝐩𝐢𝐥𝐤𝐚𝐧||𝐭𝐢𝐤𝐭𝐨𝐤 𝐚𝐝𝐦𝐢𝐧:𝐧𝐚𝐟𝐫𝐨𝐧𝐚𝐧𝐣𝐚𝐲𝟐')
            }
            break		 
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa follow tiktok admin:@nafronanjay2
